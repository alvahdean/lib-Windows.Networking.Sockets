...
2. The nuproj files (in nanoFramework.Windows.Networking.Sockets.Nuget.sln) have to be manually updated for the dependency versions to match the referenced packages.
